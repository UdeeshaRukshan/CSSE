        ...
        <main className={`flex-grow px-4 sm:px-6 lg:px-8`}>
          <div className="h-[calc(100vh-4rem)] overflow-y-auto">
            ...
            <div className="flex justify-between items-center mb-4">
              <div className={`flex-1 mr-4 ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200 text-gray-100'}  duration-300`}>
                <Input
                  type="text"
              ...
              <div className={`${isDarkMode ? 'bg-gray-700' : 'bg-gray-200 text-gray-100'}  duration-300`}>
              <Select value={filterRole} onValueChange={setFilterRole}>
                <SelectTrigger className={`w-[200px] ${isDarkMode ? 'bg-gray-700 text-white' : 'bg-white text-gray-900'}`}>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {isLoading ? (
                      ...
                      paginatedUsers
                        .filter(user => ['doctor', 'patient', 'pharmacist'].includes(user.role)) // Filter users by roles
                        .map(user => (
                          <tr key={user._id} className={`${isDarkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-200'} transition-colors duration-300`}>
                            <td className="p-2">
                              {user.imageUrl ? (
                            ...
                            <td className="p-2">
                              ...
                              <Button variant="outline" size="sm" className={`${isDarkMode ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-200 hover:bg-gray-300 text-gray-100'} transition-colors duration-300`}
