...
export default function Dashboard() {
  ...
  // Key Change 2: Updated handleDoctorAdding function with improved error handling
  ...
  return (
    <div
      className={`flex flex-col h-screen ${isDarkMode ? "bg-gray-900 text-white" : "bg-white text-gray-900"} transition-colors duration-300`}
    >
      {/* Header */}
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <aside
          className={`${isSidebarOpen ? "block" : "hidden"} lg:block fixed lg:static inset-y-0 left-0 z-50 w-64 bg-gray-800 transform transition-transform duration-200 ease-in-out ${isSmallScreen && !isSidebarOpen ? "-translate-x-full" : "translate-x-0"} h-[calc(100vh-4rem)] flex flex-col`}
        >
        ...
        <main
          className={`flex-grow px-4 sm:px-6 lg:px-8 ${isSidebarOpen ? "" : ""}`}
        >
          <div className="h-[calc(100vh-4rem)] overflow-y-auto">
              ...
              >
                ...
                >
                  ...
                  <form className="space-y-4" onSubmit={handleDoctorAdding}>
                    {/* Key Change 3: Updated input field to use 'fullname' instead of 'name' */}
                    <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              {statsData.map((stat, index) => (
                <div
                  key={index}
                  className={`p-4 rounded-lg ${isDarkMode ? "bg-gray-800" : "bg-gray-100"} transition-colors duration-300 hover:shadow-lg`}
                >
            ...
            <div
              className={`overflow-x-auto rounded-lg ${isDarkMode ? "bg-gray-800" : "bg-gray-100"} transition-colors duration-300`}
            >
